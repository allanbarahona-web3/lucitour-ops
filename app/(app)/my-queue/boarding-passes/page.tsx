...
import { ItineraryStatus, type Trip, type TripMember } from "@/lib/types/ops";
...
export default function MyQueueBoardingPassesPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Pases de Abordar</h1>
          <p className="text-sm text-slate-600">Pendientes de check-in aereo.</p>
        </div>
